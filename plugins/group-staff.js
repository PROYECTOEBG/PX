...
`.trim();
  ...
  try {
    ...
    const imageUrl = global.imageUrl || "https://qu.ax/OQNSn.jpg"; // Imagen predeterminada
    const sourceUrl = global.redes || "https://github.com/Deylinel/TECNO-BOT-OFICIAL"; // URL del proyecto
    const thumbnailUrl = global.icono || "https://d.uguu.se/TZYgiEwD.jpg"; // Miniatura
